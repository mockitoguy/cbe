...
public class FlightManager {
	...
	public ArrayList<PlanFlight> planList = new ArrayList<PlanFlight>();

	public FlightManager(ArrayList<PlanFlight> planList) {
	...
	public void addPlanFlight(String flight, String origin, String destination) {

	}

	public HashMap<String, String> getListsOfFLight(
			ArrayList<PlanFlight> planList, String origin, String destination) {
		HashMap<String, String> temp = new HashMap<String, String>();
		for (PlanFlight pf : planList) {
			if (pf.getOrigin().equals(origin)
					&& pf.getDestination().equals(destination)) {
				temp.put(pf.getFlight(), pf.getDate());
			}
	...
	public ArrayList<String> getListFromOrigin(String origin) {
		ArrayList<String> temp = new ArrayList<String>();

		for (PlanFlight pf : planList) {
			if (pf.getOrigin().equals(origin)) {
				temp.add(pf.getFlight());
			}
		}
		return temp;
	}

	public ArrayList<String> getListToDestination(String destination) {
		ArrayList<String> temp = new ArrayList<String>();

		for (PlanFlight pf : planList) {
			if (pf.getDestination().equals(destination)) {
				temp.add(pf.getFlight());
			}
		}
		return temp;
